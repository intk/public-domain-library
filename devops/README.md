...
```
DEPLOY_ENV=prod
DEPLOY_HOST=www.publicdomainlibrary.org
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    www.publicdomainlibrary.org:
      ansible_user: root
      host: www
      hostname: www.publicdomainlibrary.org
```
...
Deploy the stack defined in `devops/stacks/www.publicdomainlibrary.org.yml` to the remote server with:
