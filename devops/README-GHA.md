...
2. Go to your repository at [github.com/intk/public-domain-library](https://github.com/github.com/intk/public-domain-library).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `www.publicdomainlibrary.org` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | www.publicdomainlibrary.org | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | www.publicdomainlibrary.org |
...
- [Backend Tests Workflow](https://github.com/github.com/intk/public-domain-library/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/github.com/intk/public-domain-library/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`github.com/intk/public-domain-library-backend`) and Frontend (`github.com/intk/public-domain-library-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of www.publicdomainlibrary.org](https://github.com/github.com/intk/public-domain-library/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/www.publicdomainlibrary.org.yml` stack.
